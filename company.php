...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="company.php">Company <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <!-- form for company data insert -->
        <div class="container">
            <form class="mt-4" method="post">
                <h3>Company Data Insert</h3>
